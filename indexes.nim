...
type
  ...
  MWPathgridFlags* = enum  # values below are the only ones accessible via the TESCS
    Granularity128  = 128    # other values exist between the range of 0x1 and 0x4000 (with the exception of 0x4)
    Granularity256  = 256    # but appear to be deprecated outside of cell [0, 0]
    Granularity512  = 512
    Granularity1024 = 1024
    Granularity2048 = 2048 # | default
    Granularity4096 = 4096
  MWCellFlags* = enum
    Interior       = 1   # 0x01
    HasWater       = 2   # 0x02
